    ...
    <main>
      ...
      <section className='bg-white pb-10'>
        ...
        <div className='grid grid-cols-3 gap-10 w-9/12 mx-auto'>
          ...
          <article className='p-8 rounded-2xl flex flex-col shadow-[-5px_5px_30px_0px_#BCEF30] justify-between'>
          ...
          <div className='flex flex-col gap-5 justify-between'>
            ...
            <article className='flex flex-col justify-between shadow-[0px_-3px_30px_0px_#BCEF30] rounded-2xl p-10'>
            ...
            <article className='flex flex-col justify-between shadow-[5px_5px_20px_0px__#D782FF] rounded-2xl p-10'>
              <div className='h-20'>&nbsp;</div>
          ...
          <article className='p-8 rounded-2xl flex flex-col gap-8 justify-between shadow-[0px_3px_20px_0px_#D782FF]'>
