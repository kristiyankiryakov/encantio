...
function ProductCard({ product }: Props) {
    ...
    return (
        <div className='z-20 mx-auto flex flex-col flex-wrap gap-10 w-[30%] xs:min-w-[20rem] md:min-w-[10rem] xs:p-6 xl:p-8 rounded-md border border-1 border-gray-200/20  bg-cardBackground relative xs:text-xs sm:text-sm'>
            ...
            <div className='flex flex-col xs:gap-2 xl:gap-5'>
                ...
                <div className='pricing-and-offer xs:flex xl:flex-row flex items-center justify-between xs:w-full'>
                    <p className='price text-white text-xl' ><span className='pr-1 xs:text-xl font-medium' >14</span>лв.</p>

                    <p className='offer-description text-customGray w-full xs:text-sm xl:text-xl pl-3' >за единичен сет крачета</p>
                </div>

                <div className='bg-gray-700 w-full h-[0.065rem]' >&nbsp;</div>

                <div className="flex items-center xs:text-sm xl:text-lg" >
                    <span className="text-electricGreen text-xl" >-10%</span>
                    <p className="text-customGray pl-3 tracking-wide" >при поръчка на<span className="text-electricGreen" > 2 или повече</span></p>
                </div>  
